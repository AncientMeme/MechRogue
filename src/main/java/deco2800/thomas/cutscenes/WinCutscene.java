...
public class WinCutscene implements Screen {
     ...
     * constructor
     */
    public WinCutscene(ThomasGame thomasGame){
        this.thomasGame = thomasGame;
        // set an image as the bg，create as texture and add them to list
        imageContainer1 = new Texture(Gdx.files.internal("resources/Ending_scenes/Frame_1.png"));
        imageContainer2 = new Texture(Gdx.files.internal("resources/Ending_scenes/Frame_2.png"));
        imageContainer3 = new Texture(Gdx.files.internal("resources/Ending_scenes/Frame_3.png"));
        imageContainer4 = new Texture(Gdx.files.internal("resources/Ending_scenes/Frame_4.png"));
        imageContainer5 = new Texture(Gdx.files.internal("resources/Ending_scenes/Frame_5.png"));
        imageContainer6 = new Texture(Gdx.files.internal("resources/Ending_scenes/Frame_6.png"));
        imageContainer7 = new Texture(Gdx.files.internal("resources/Ending_scenes/Frame_7.png"));
        imageContainer8 = new Texture(Gdx.files.internal("resources/Ending_scenes/Frame_8.png"));
        imageContainer9 = new Texture(Gdx.files.internal("resources/Ending_scenes/Frame_9.png"));
        // create stage
...
//            skipButton.setVisible(false);
    ...
    public void closeAnimation(){
        ...
        RunnableAction backMenu = Actions.run(new Runnable() {
            @Override
            public void run() {
                thomasGame.showStartScreen();
            }
        });
        AfterAction afterAction = Actions.after(backMenu);
        getCurrentFragment().addAction(sequenceAction);
        fragment9.addAction(afterAction);
    }
