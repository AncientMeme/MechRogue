...
/*
 * !! SOURCED FROM https://gist.github.com/KdotJPG/b1270127455a94ac5d19 !!
 *
 * 2014 OpenSimplex 2 Noise in Java.
 * by Kurt Spencer
 *
 ...
 * try the newer OpenSimplex2S or OpenSimplex noise. These are located in the OpenSimplex2 repo:
...
public class OpenSimplexNoise {
    ...
    /**
     * Function used to set the seed / reset the noise gen
     */
    ...
    /**
     * 4D OpenSimplex noise, classic lattice orientation.
     */
    ...
    /**
     * 4D OpenSimplex noise, with XYZ oriented like noise3_Classic,
    ...
    private static class LatticePoint3D {
        private final double dxr, dyr, dzr;
        private final int xrv, yrv, zrv;
