...
public class SaveLoadTest {
    ...
    public void SetMapTest() {
        ...
        //New method from @samnolan4
        AbstractWorld q = null;
        try {q = AbstractWorld.deserialize("savetest.txt");}
        catch(IOException ex)
        {
